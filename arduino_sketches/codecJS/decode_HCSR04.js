...
function Decode(fPort, bytes) {
    ...
    for (var j=n_irq_pins; j<bytes.length; j+=5){
        ...
        switch(charCode){
            case 'D'://Nomenclature identifiant la donnée du capteur venant de l'Arduino
                decoded.distance = f_val;//Nomenclature identifiant la donnée dans l'objet json généré
                break;
        }
    }
